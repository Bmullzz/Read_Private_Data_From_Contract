...
describe("Attack", function() {
    it("Should bbe able to read the private variables password and username", async function() {
        // Deploy the contract
        const loginFactory = await ethers.getContractFactory("Login");

        // To save space, we would convert the string to a bytes32 array
